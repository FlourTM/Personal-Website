document.addEventListener('DOMContentLoaded', function () {
    ...
    handleHover(github, '../assets/githubHover.svg', '../assets/github.svg')
    handleHover(linkedin, '../assets/linkedinHover.svg', '../assets/linkedin.svg')
    handleHover(etsy, '../assets/etsyHover.svg', '../assets/etsy.svg')
